...
* auf der Webseite von Greenpeace eine Bildergalerie
...
* erreicht worden ist, soll die Galerie wieder vorne beginnen.
* Genau gleich soll das verhalten sein, wenn man #back klickt
* und das erste Bild erreicht hat, dann soll die Gallerie
* wieder von hinten beginnen.
*
* Das Bild, das aktuell im HTML in der Galerie platziert ist
* kannst du löschen, das soll alles dynamisch über JavaScript
* geladen werden.
* */
